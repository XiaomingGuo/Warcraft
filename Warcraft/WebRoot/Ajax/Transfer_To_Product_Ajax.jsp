...
<%@ page import="com.jsp.support.Transfer_To_Product_Ajax" %>
...
<%
	...
	else
	{
		...
		Transfer_To_Product_Ajax hPageHandle = new Transfer_To_Product_Ajax();
		
		if (barcode != null && !barcode.isEmpty() && POName != null && !POName.isEmpty() &&  PutQty != null && !PutQty.isEmpty())
		{
			rtnRst += hPageHandle.ExecuteTransferSemiProductToProduct(barcode, POName, PutQty) + "$";
		}
		else
		{
