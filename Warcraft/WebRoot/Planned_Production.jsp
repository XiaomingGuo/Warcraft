...
<%@ page import="com.jsp.support.Planned_Production" %>
<jsp:useBean id="mylogon" class="com.safe.UserLogon.DoyouLogon" scope="session"/>
<%
    String message="";
    Planned_Production hPageHandle = new Planned_Production();
    ...
    else
    {
        ...
        else
        {
            ...
            if(null == curPOName)
                curPOName = "";
            List<String> POList = hPageHandle.GetPlannedPOList();
%>
...
<html>
  <head>
    ...
    <script language="javascript" src="JS/jquery-1.11.3.min.js"></script>
      ...
      <script language="javascript" src="Page_JS/Planned_ProductionJS.js"></script>
  ...
  <body onload="changePOName()">
    ...
    <table align="center">
        <tr>
            <td>
                  <table align="center">
                      <tr><td align="center"><h2>请选择PO单</h2></td></tr>
                      <tr>
                          <td align="right">
                              <h1>
                                  <label>PO号:</label>
