...
dojo.hostenv.packageLoaded({depends:[["provide", "dojo.date.format"], ["require", "dojo.date.common"], ["require", "dojo.date.supplemental"], ["require", "dojo.lang.array"], ["require", "dojo.lang.common"], ["require", "dojo.lang.func"], ["require", "dojo.string.common"], ["require", "dojo.i18n.common"], ["xdRequireLocalization", "dojo.i18n.calendar", "gregorian", null, "ja,es,de,zh,zh-tw,zh-hk,pt,sv,pt-br,en,nl,fr,ko,zh-cn,it,fi,hu,ROOT", "ja,es,de,zh,zh-tw,zh-hk,pt,sv,pt-br,en,nl,fr,ko,zh-cn,it,fi,hu,ROOT"], ["xdRequireLocalization", "dojo.i18n.calendar", "gregorianExtras", null, "ja,zh,ROOT", "ja,zh,ROOT"]], definePackage:function (dojo) {
