...
import com.DB.support.ExhaustedManuStorageRecord;
...
public class Exhausted_Manu_Storage_Record implements ITableInterface, IStorageTableInterface
{
	...
	public Exhausted_Manu_Storage_Record(){}
	...
	{
		return "ExhaustedManuStorageRecord";
	}
	...
	public List<String> getDBRecordList(String keyWord)
	{
		...
		Iterator<ExhaustedManuStorageRecord> it = resultList.iterator();
		while(it.hasNext())
		{
			ExhaustedManuStorageRecord tempRecord = (ExhaustedManuStorageRecord)it.next();
			switch (keyWord)
			{
			case "id":
	...
	{
		aWriteRecord = new ExhaustedManuStorageRecord();
