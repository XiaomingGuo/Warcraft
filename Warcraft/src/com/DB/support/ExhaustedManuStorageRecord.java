...
/**
 * ExhaustedManuStorageRecord entity. @author MyEclipse Persistence Tools
 */

public class ExhaustedManuStorageRecord implements java.io.Serializable {
	...
	/** default constructor */
	public ExhaustedManuStorageRecord() {
	}

	/** full constructor */
	public ExhaustedManuStorageRecord(String barCode, String batchLot,
			Integer inQty, Integer outQty, Float pricePerUnit,
			Double totalPrice, String orderName, String poName,
