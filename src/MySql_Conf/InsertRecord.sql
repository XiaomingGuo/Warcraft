...
INSERT INTO `earthquake`.`material_record` (`proposer`,`material_name`,`QTY`) VALUES ("wallace.guo","中性笔",1,0);
INSERT INTO `earthquake`.`material_record` (`proposer`,`material_name`,`QTY`) VALUES ("郭晓明","铁块",1,0);
INSERT INTO `earthquake`.`material_record` (`proposer`,`material_name`,`QTY`) VALUES ("郭晓明","中性笔芯",1,0);