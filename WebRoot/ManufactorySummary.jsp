...
<%@ page import="com.jsp.support.ManufactorySummary" %>
<jsp:useBean id="mylogon" class="com.safe.UserLogon.DoyouLogon" scope="session"/>
<%
	String message="";
	ManufactorySummary hPageHandle = new ManufactorySummary();
...
<%
					...
					{
%>
				  	<option value = <%=storeNameList.get(i) %>><%=storeNameList.get(i)%></option>
<%
					}
%>
			  	</select>
