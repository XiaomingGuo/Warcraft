...
<%
	...
	else
	{
		...
		else
		{
			...
			if(null == curPOName)
				curPOName = "";
			hSPSHandle.QueryRecordByKeyListGroupByList(Arrays.asList("po_name"));
			List<String> POList = hSPSHandle.getDBRecordList("po_name");
%>
...
<html>
  <head>
	...
	<script language="javascript" src="JS/jquery-1.11.3.min.js"></script>
  	...
  	<script language="javascript" src="Page_JS/Transfer_To_ProductStorageJS.js"></script>
  ...
  <body onload="changePOName()">
    ...
    <table align="center">
    	<tr>
    		<td>
		  		<table align="center">
		  			<tr><td align="center"><h2>半成品转成品</h2></td></tr>
		  			<tr>
				  		<td align="right">
				  			<h1>
						  		<label>PO号:</label>
