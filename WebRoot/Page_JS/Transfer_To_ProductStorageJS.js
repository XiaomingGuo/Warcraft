				...
				for(var iRow = 1; iRow <= iRowCount; iRow++)
				{
					...
					for (var iCol = 1; iCol <= iColCount; iCol++)
					{
						...
						if (0 == iColCount - iCol)
						{
							...
							{
								td.append("<input type='button' value='转出' name='" + data_list[iRow*iColCount + iCol + 2] + "$" + data_list[iRow*iColCount + 3] + "' id='" +data_list[iRow*iColCount + 3] + "_Button' onclick=AddToMaterialStorage(this)>");
							}
							else
							{
