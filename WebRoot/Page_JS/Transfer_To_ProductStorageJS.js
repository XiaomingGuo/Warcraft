...
function changePOName()
{
	...
	$.post("Ajax/Query_SemiPro_PO_Item_Ajax.jsp", {"po_name":po_name}, function(data, textStatus)
	{
...
function DoTransfer(obj)
{
	...
	$.post("Ajax/Transfer_To_Product_Ajax.jsp", {"Bar_Code":tempList[0], "PO_Name":tempList[1], "TransQty":storeQTY}, function(data, textStatus)
	{
		if (!(textStatus == "success"))
		{
			alert(data);
		}
		location.href ="Transfer_To_ProductStorage.jsp?POName="+data.split('$')[1];
	});
}
