...
dojo.hostenv.packageLoaded({depends:[["provide", "dojo.widget.TimePicker"], ["require", "dojo.widget.*"], ["require", "dojo.widget.HtmlWidget"], ["require", "dojo.event.*"], ["require", "dojo.date.serialize"], ["require", "dojo.date.format"], ["require", "dojo.dom"], ["require", "dojo.html.style"], ["xdRequireLocalization", "dojo.i18n.calendar", "gregorian", null, "ja,es,de,zh,zh-tw,zh-hk,pt,sv,pt-br,en,nl,fr,ko,zh-cn,it,fi,hu,ROOT", "ja,es,de,zh,zh-tw,zh-hk,pt,sv,pt-br,en,nl,fr,ko,zh-cn,it,fi,hu,ROOT"], ["xdRequireLocalization", "dojo.widget", "TimePicker", null, "ROOT", "ROOT"]], definePackage:function (dojo) {
